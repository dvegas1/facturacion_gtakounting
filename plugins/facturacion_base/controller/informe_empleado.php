...
class informe_empleado extends fbase_controller
{
    ...
    {
        parent::__construct(__CLASS__, 'Empleados', 'informes');
    }
   ...
   //     $this->almacenselect=$_POST['codalmacen_articulo'];
       ...
       $alm_cod .=  "'" . $alm->codalmacen .  "',";
        ...
        if (!$toplist || isset($_POST['desde'])) {
            $toplist = array();
            $articulo = new articulo();
            $sql = "SELECT  age.nombre as agente,l.referencia, SUM(l.cantidad) as unidades, SUM(l.pvptotal/f.tasaconv) as total,f.codalmacen as almacen,f.fecha as fecha"
