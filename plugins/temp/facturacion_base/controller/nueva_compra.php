 ...
 class nueva_compra extends fbase_controller
 {
     ...
     protected function private_core()
     {
         ...
         if (isset($_POST['palabras_a_bloquar'])) {

             $palabra_bloque = new articulo();
             $this->template = FALSE;
             if(isset($_POST['palabras_a_bloquar']) && isset($_POST['accion'])){

             echo json_encode($palabra_bloque->Agregar_bloquadas_ocr($_POST['palabras_a_bloquar'],$_POST['accion']));
             }


         }

         if (isset($_POST['cargar_palabra'])) {

             $articulo_bs_ocr = new articulo();
             $this->template = FALSE;
             echo json_encode($articulo_bs_ocr->cargar_palabras($_POST['cargar_palabra']));
         ...
         if (isset($_REQUEST['buscar_proveedor'])) {
         ...
         } else if (isset($_POST['buscar_proveedor_ocr'])) {

               $this->template = FALSE;
               header('Content-Type: application/json');
              echo json_encode($this->proveedor->get_proveedor($_POST['buscar_proveedor_ocr']));
             ...
             $this->new_articulo();
         } else if (isset($_REQUEST['busqueda_ocr'])) {
             $this->articulo_bs_ocr = new articulo();
             $this->template = FALSE;
             echo json_encode($this->articulo_bs_ocr->get_articulo_ocr($_REQUEST['busqueda_ocr']));
