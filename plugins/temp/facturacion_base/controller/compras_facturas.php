...
class compras_facturas extends fbase_controller
{
    ...
    protected function private_core()
    {
        ...
        if (isset($_POST['buscar_proveedor_ocr'])) {
            $proveedor_ocr = new proveedor();
            $this->template = FALSE;
            echo json_encode($proveedor_ocr->get_proveedor($_POST['buscar_proveedor_ocr']));


        }

        if (isset($_POST['nombre_sugerencia'])) {
            $proveedor_ocr_nombre = new proveedor();
            $this->template = FALSE;

            echo json_encode($proveedor_ocr_nombre->agregar_sugerencias($_POST['nombre_sugerencia'],$_POST['nombre_sugerido'],$_POST['tipo'],$_POST['id']));
