...
class tpv_comanda extends fs_model
{
    ...
    public function delete()
    {
      ...
      $ACTUALIZARSTOCK= "SELECT li.idtpv_comanda as nrocomanda,li.referencia,li.cantidad,co.codalmacen FROM tpv_comandas co LEFT JOIN tpv_lineascomanda li on co.idtpv_comanda = li.idtpv_comanda
    ...
    $valores = array();
        ...
        $valores=$value;
          ...
          $this->new_message(json_encode($data['0']['nrocomanda']));
