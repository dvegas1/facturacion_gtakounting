...
class articulo extends \fs_model
{
    ...
    public function validarProduct($REF) {
      ...
      $campos="SUM(STO.cantidad) as total";
      ...
      $valdisponible = "SELECT SUM(disponible) + 1  as disponible FROM stocks WHERE referencia ="  . "'" . $REF . "'" . " AND  codalmacen = " ."'" . $this->almacencode . "'" . ";";
    ...
    /*  $campos="SUM(STO.cantidad) as total1";
      ...
      $campos="al.nombre as nombre,STO.cantidad as cantidad";
