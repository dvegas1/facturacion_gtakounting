...
$(".print_articulos").click(function () {
    alert();
})
...
function printDiv1(elementId) {
    ...
    css.setAttribute("href", "{#FS_PATH#}view/css/bootstrap.min.css");
    css.setAttribute("rel", "stylesheet");
    css.setAttribute("type", "text/css media=all");
    css.setAttribute("media", "print");
    $(elementId).css("width", "90%");



    ventimp.document.head.appendChild(css);
    ventimp.document.write(elementId.innerHTML);
